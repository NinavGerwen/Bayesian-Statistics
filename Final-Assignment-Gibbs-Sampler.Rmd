...
p_value
```
This means that 61.5% of the time, the mean - median squared of the residuals in a simulated dataset are larger than in the observed dataset. in other words, 61.5% of the time, the residuals in a simulated dataset follow a less normally distributed distribution?
