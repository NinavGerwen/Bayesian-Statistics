...
library(haven)
testdat <- read_sav(file = "FEARadapted.sav")

summary(lm(exam ~ fost + confid, data = testdat))

GibbsSampler(testdat$exam, testdat$fost, testdat$confid, burn.in = 6000, iterations = 20000, initial.values = c(50, .01, .1))
```
